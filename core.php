<?php
    ...
    function saveDato($dato){
        ...
        $sql="INSERT INTO `partidarios` (`nombre/s`, `apellido/s`, `cedula`, `fechaNacimiento`, `edad`, `ciudad`, `zodiaco`, `foto`) 
                VALUES ('{$dato->nombre}', '{$dato->apellido}', '{$dato->cedula}', '{$dato->fechaNacimiento}', '{$dato->edad}', '{$dato->lugarNacimiento}', '$z', '{$dato->foto}')";
